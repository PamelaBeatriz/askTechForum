    ...
    <div id="site_content">
      <div class="content">
        ...
        <div class="content_item">
          <p>O Ask Tech Forum foi um projeto criado por um grupo de alunos do IFPE para que você pudesse, além de expor suas dúvidas, também ajudar a sanar as dúvidas de outros usuários sobre diversos assuntos de tecnologia.  </p>
          <p></p><p></p>
...
<!--           <p>Evite respostas como: "Obrigado", "Problema resolvido"... Prefira marcar a resposta como solução. Dessa forma, todos verão facilmente que o tópico foi solucionado.</p> -->
          <p>Cuidado com expressões do tipo: "kkkk", "rsrs" ou palavras de baixo calão. Isso polui o texto e faz com que o seu post talvez não seja levado à sério pela comunidade.</p>
